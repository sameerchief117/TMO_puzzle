describe('When: I use the reading list feature', () => {
  ...
  it('Then: I should be able to add book to reading list and UNDO this action', async () => {
  ...
  it('Then: I should be able to delete the book from reading list and UNDO this action', async () => {
    let beforeLength;
    cy.get('input[type="search"]').type('javascript');
